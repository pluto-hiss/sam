...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="blue", secondary_hue="indigo")) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=2):
            ...
            with gr.Tabs():
                with gr.TabItem("Concept Prompting (Normal Mode)"):
    ...
    gr.Markdown(
        ...
        2. **Concept Prompting:** Upload an image, type a concept name, adjust the confidence slider, and click **Run Segmentation**.
        3. **Auto-Segment Everything:** Go to the **Auto-Segment Everything** tab, upload an image, and click **Auto-Segment Everything** to isolate all items.
        """
    )
